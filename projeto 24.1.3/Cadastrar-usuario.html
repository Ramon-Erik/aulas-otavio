...
<body>
  <section class="menu cid-u6mLn3V0gW" once="menu" id="menu1-1i">
...
<section class="engine"><a href="https://mobirise.info/n">simple site templates</a></section><section class="header15 cid-u6mLn4XR4m mbr-fullscreen mbr-parallax-background" id="header15-1j">
    ...
    <div class="container align-right">
        <div class="row">
            <div class="mbr-white col-lg-8 col-md-7 content-container">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">Cadastro de usuarios</h1>
                <p class="mbr-text pb-3 mbr-fonts-style display-5">Cadastrar usuario do sistema de acordo com os dados da secretaria da escola.</p>
            </div>
...
<section class="cid-u6mLn5DB2D" id="footer2-1k">
