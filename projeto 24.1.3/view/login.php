        ...
        <div class="container align-right">
            <div class="row">
                <div class="mbr-white col-lg-8 col-md-7 content-container">
                    <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">Autenticação</h1>
                    <p class="mbr-text pb-3 mbr-fonts-style display-5">Entre com seu email e senha.</p>
                </div>
                <div class="col-lg-4 col-md-5">
                    <div class="form-container">
                        <div class="media-container-column">
                            <!---Formbuilder Form--->
                            <form action="../control/controle-login.php" method="GET">
                                <div class="dragArea row">
                                    <div class="col-md-12 form-group " data-for="email">
                                        <input type="email" name="email" placeholder="Email" required="required" class="form-control px-3 display-7" id="email-header15-1f">
                                    </div>
                                    <div class="col-md-12 form-group " data-for="email">
                                        <input type="password" name="senha" placeholder="Senha" required="required" class="form-control px-3 display-7" id="senha-header15-1f">
                                    </div>
                                    
                                    <div class="col-md-12 input-group-btn">
                                        <input type="hidden" value="2" name="opc">
                                        <input type="submit" value="Entrar" class="btn btn-form btn-primary display-200" id="btn" name="login_aluno">
                                    </div>
                                </div>
