...
<body>
    <main>
        ...
        <form action="../control/controle-autenticacao.php" method="post">
            <div class="coluna index">
                ...
                <div class="linha">
                    ...
                    <input type="text" placeholder="Ex: 1" name="numConta" id="iNumConta">
                </div>
                <div class="linha">
    ...
    <footer>
        <p>&copy; Por <a href="http://github.com/ramon-erik" target="_blank" rel="noopener noreferrer">Ramon Erik</a>
        </p>
    </footer>
</body>
